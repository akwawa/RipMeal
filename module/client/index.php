...
if (!empty($_SESSION[$application]['idRank'])) {
	...
	<td><a class="popup" href="#" onclick="action(this);" data-id="'.$line['c.id'].'">Action</a></td>
			...
			$page['header']['js']['direct'][] = '$(document).ready(function(){$("#table_client").DataTable({"sDom":"CRT<\"clear\">lfrtip","bStateSave":true, "oTableTools":{"sSwfPath":"swf/copy_csv_xls_pdf.swf"},"oLanguage":{"sUrl":"js/dataTable.french.txt.js"}});$("#table_client").dataTable().columnFilter();$(".popup").click(function(){return false;});});';
		}
	}
}
